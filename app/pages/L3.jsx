    ...
    <View style={styles.container}>
      <ScrollView contentContainerStyle={styles.scrollContainer}>
        ...
        />
          ...
          Tire um tempinho para relaxar e conferir umas citações que vão trazer aquele toque de tranquilidade que você merece.  
          </Text>
        </View>

        {/* Botões de Tópicos */}
        <TopicButton
          icon={require('../../assets/icon5.png')} // Substitua pelo caminho correto da imagem
          title="Citações"
          onPress={handleC}
        />

        <TopicButton
          icon={require('../../assets/icon6.png')} // Substitua pelo caminho correto da imagem
          title="Melodias de sono"
